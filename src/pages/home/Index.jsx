...
const Index = () => {
  const [content, setContent] = useState(""); // เก็บเนื้อหาที่จะแสดง

  // ฟังก์ชั่นสำหรับการเปลี่ยนแปลงเนื้อหาเมื่อคลิกที่ลิงก์
  ...
  return (
    <div className="container mx-auto ">
      {/* Title */}
      <p className="font-normal text-5xl text-start  py-4 text-gray-600">
        ยินดีต้อนรับ{" "}
